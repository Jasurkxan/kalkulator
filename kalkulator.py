...
class Kalkulator(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setGeometry(700, 300, 360, 350)
    ...
    def UiComponents(self):
        ...
        self.label.setStyleSheet("QLabel""{""border-radius:10px;border : 4px solid black;""background : silver;""}")
        ...
        bracket.setGeometry(95, 100, 80, 40)

        bracket2=QPushButton(")",self)
        bracket2.setGeometry(185, 100, 80, 40)
        ...
        bracket.clicked.connect(self.bracket1)
        bracket2.clicked.connect(self.bracket2)
